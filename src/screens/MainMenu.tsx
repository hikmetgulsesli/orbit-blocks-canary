...
export function MainMenu({ actions }: MainMenuProps) {
  return (
    <>
      <header>
          <div><div className="meta">Small English Falling Blocks PRD</div><h1>Main Menu</h1><p>Start, resume, restart, and any task-requested mode or difficulty actions.</p></div>
